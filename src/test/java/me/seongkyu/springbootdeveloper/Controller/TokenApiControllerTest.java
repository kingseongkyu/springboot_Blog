...
import me.seongkyu.springbootdeveloper.config.jwt.JwtFactory;
import me.seongkyu.springbootdeveloper.config.jwt.JwtProperties;
import me.seongkyu.springbootdeveloper.domain.RefreshToken;
import me.seongkyu.springbootdeveloper.domain.User;
import me.seongkyu.springbootdeveloper.dto.CreateAccessTokenRequest;
...
public class TokenApiControllerTest {
    ...
    public void createNewAccessToken() throws Exception {
        ...
        //when(토큰 추가 API에 요청을 보냄. 이때 요청 타입은 JSON, given절에서 미리 만들어둔 객체를 요청 본문으로 함께 보냄
